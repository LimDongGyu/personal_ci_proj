  ...
  */
   ...
   */
    ...
    */
     ...
     *         ㄴ crmDB -> reserve_chart TABLE -> phone
     *   1.2. 본인인증 절차(문자 등)
    ...
    *   //1.3. 날짜 선택
    *     //1.3.1. 날짜 선택 방식?
    *      // ㄴ [방법1] 월 -> 일 -> 시간 선택                => 절차가 하나 더 있지만 노출할 수 있는 날짜가 범용적
    *      // ㄴ [방법2] 한번에 월, 일 노출 -> 시간 선택       => 절차가 하나 없지만 노출할 수 있는 날짜가 한정적
    * 
    *   1.4. 최종 예약 저장 테이블?
    ...
    */
     ...
     *   1. 환경세팅
     *      ㄴ 함수 사용?
     *      ㄴ 이벤트(날짜) 있는 것 외는 실행 안됨
     *   2. 카카오톡 채널관리 변경
     *   3. 카카오마스터 컨트롤러 내 함수 사용법(time, post)
     *   4. for -> foreach 수정
     *   5. 최종예약
     *   6. 본인인증 문자
     * 
     * 
     * ? 수시로 ssh로 git commit 하기
     * 
     * git bash 창
     * ssh musecrm@musecrm.cafe24.com
     * 
     * cd www/
     * git status 확인
     * git log -1 (로그 확인)
