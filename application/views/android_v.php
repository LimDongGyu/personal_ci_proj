        ...
        <div id="nav-height">
            <section>
                <div class="article">
                    ...
                    <p class="article-license">Content and code samples on this page are subject to the licenses described in the <a href="#">Content License</a>. Java is a registered trademark of Oracle and/or its affiliates. Last updated 2019-12-27.</p>
                </div>
            </section>
            <aside></aside>
            <footer>
                <div class="footer-sns">
                    <div class="footer-sns-kinds">
                        <img src="https://developer.android.com/_static/android/images/logo-twitter.svg?hl=ko"/>
                        <div><h4>Twitter</h4></div>
                        <div>Twitter에서 @AndroidDev 팔로우</div>
                    </div>
                    <div class="footer-sns-kinds">
                        <img src="https://www.gstatic.com/images/icons/material/product/2x/youtube_48dp.png"/>
                        <div><h4>YouTube</h4></div>
                        <div>Youtube에서 Android 개발자 확인</div>
                    </div>
                </div>
                <div class="footer-list">
                    <ul class="footer-ul">
                        <li style="footer-ul-header"><a href="#">Android 자세히 알아보기</a></li>    
                    ...
                    <ul class="footer-ul">
                        <li style="footer-ul-header"><a href="#"">지원</a></li>    
                    ...
                    <ul class="footer-ul">
                        <li style="footer-ul-header"><a href="#">문서</a></li>    
                ...
                <div class="footer-guide">
                    <nav class="nav-guide">
                        <a class="footer-guideline" href="#">개인정보보호</a><span style="float:left; height:50px; line-height:50px;"> | </span>
                        <a class="footer-guideline" href="#">라이선스</a><span style="float:left; height:50px; line-height:50px;"> | </span>
                        <a class="footer-guideline" href="#">브랜드 가이드라인</a>
